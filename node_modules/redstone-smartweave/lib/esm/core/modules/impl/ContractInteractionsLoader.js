import { Benchmark, LoggerFactory, sleep, SmartWeaveTags } from '../../..';
const MAX_REQUEST = 100;
export class ContractInteractionsLoader {
    constructor(arweave) {
        this.arweave = arweave;
        this.logger = LoggerFactory.INST.create('ContractInteractionsLoader');
    }
