 ...
 */
export class BsonFileBlockHeightSwCache {
    constructor(basePath) {
        this.logger = LoggerFactory.INST.create('BsonFileBlockHeightSwCache');
        this.updatedStorage = {};
        this.saving = false;
        this.putCounter = 0;
        ...
        try {
            ...
            Object.keys(this.updatedStorage).forEach((key) => {
                ...
                for (const height of Object.keys(this.updatedStorage[key])) {
                    fs.writeFileSync(path.join(directoryPath, directory, `${height}.cache.bson`), BSON.serialize(this.updatedStorage[key][height]));
                }
            });
        }
        finally {
