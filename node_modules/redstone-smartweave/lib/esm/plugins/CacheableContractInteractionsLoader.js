import { BlockHeightKey, LoggerFactory } from '..';
/**
...
export class CacheableContractInteractionsLoader {
    ...
    async load(contractId, fromBlockHeight, toBlockHeight, evaluationOptions) {
        ...
        const missingInteractions = await this.baseImplementation.load(contractId, cachedHeight + 1, toBlockHeight, evaluationOptions);
