...
class TransactionUploader {
    ...
    constructor(blockweave, transaction, crypto) {
        ...
        if (transaction instanceof transaction_1.default) {
            ...
            this.transaction = new transaction_1.default(Object.assign({}, transaction, { data: new Uint8Array(0) }), this.blockweave);
        }
    }
    /**
    ...
    async uploadChunk() {
        ...
        const chunkOk = await this.merkle.validatePath(this.transaction.chunks.data_root, parseInt(chunk.offset, 10), 0, parseInt(chunk.data_size, 10), (0, buffer_1.b64UrlToBuffer)(chunk.data_path));
        if (!chunkOk) {
     ...
     * @param data
     */
    static async fromSerialized(blockweave, serialized, data, crypto) {
        if (!serialized || typeof serialized.chunkIndex !== 'number' || typeof serialized.transaction !== 'object') {
            throw new Error(`Serialized object does not match expected format.`);
        }
        // Everything looks ok, reconstruct the TransactionUpload,
        // prepare the chunks again and verify the data_root matches
        const upload = new TransactionUploader(blockweave, new transaction_1.default(serialized.transaction, blockweave), crypto);
    ...
    async getUploader(upload, data) {
        ...
        if (upload instanceof transaction_1.default) {
            ...
            uploader = await TransactionUploader.fromSerialized(this.blockweave, upload, data, this.crypto);
        }
        return uploader;
    }
    /**
